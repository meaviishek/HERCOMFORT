...
const CATEGORIES = [
  {
    id: "cramps", label: "For Cramps", icon: "flower-outline", color: T.pink.primary, bg: T.pink.bg,
    exercises: [
  ...
  {
    id: "back", label: "For Back Pain", icon: "body-outline", color: "#8b5cf6", bg: "#f5f0ff",
    exercises: [
  ...
  {
    id: "relax", label: "For Relaxation", icon: "leaf-outline", color: "#059669", bg: "#f0fff8",
    exercises: [
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: T.bg.screen }}>
      ...
      <View style={{ flexDirection: "row", paddingHorizontal: 20, paddingVertical: 14, gap: 10 }}>
        {CATEGORIES.map(c => (
          <TouchableOpacity key={c.id} onPress={() => setActiveCat(c.id)}
            ...
            <Ionicons name={c.icon as any} size={18} color={activeCat === c.id ? "#fff" : T.text.muted} style={{ marginBottom: 3 }} />
            <Text style={{ fontSize: 11, fontWeight: "700", color: activeCat === c.id ? "#fff" : T.text.muted, textAlign: "center" }}>{c.label.replace("For ", "")}</Text>
          </TouchableOpacity>
        ))}
      </View>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 20, paddingBottom: 40 }}>
        <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 4 }}>
          ...
          <Text style={{ fontSize: 18, fontWeight: "900", color: T.text.primary }}>{cat.label}</Text>
        </View>
          ...
          <TouchableOpacity key={ex.name} onPress={() => setModal(ex)} activeOpacity={0.9}
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }}>
              ...
              <View style={{ alignItems: "flex-end" }}>
                <View style={{ backgroundColor: cat.color + "20", borderRadius: 12, paddingHorizontal: 10, paddingVertical: 5, marginBottom: 8, flexDirection: "row", alignItems: "center", gap: 4 }}>
                  <Feather name="clock" size={12} color={cat.color} />
              ...
              <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
                <View style={{ flex: 1, marginRight: 12 }}>
                  ...
                  <View style={{ flexDirection: "row", alignItems: "center", gap: 4, marginTop: 4 }}>
                    <Feather name="clock" size={13} color={T.text.muted} />
